...
namespace SistemaContas.Infra.Reports
{
    public class ContaReport : IContaReport
    {
        ...
        public byte[] CreatePdf(List<Conta> contas)
        {
            ...
            {
                var logo = ImageDataFactory.Create("http://www.cotiinformatica.com.br/imagens/logo-coti-informatica.png");
                ...
                document.Add(new Paragraph($"Quantidade de contas: {contas.Count}").AddStyle(new Style().SetFontSize(14)));
            }
